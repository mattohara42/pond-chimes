...
- **Shore** — the left side is dry ground (a soil bank), with a fringe of big smooth boulders and pebbles half-embedded along it as the shoreline; the open water begins to their right. The stone line is uneven — thicker in places, tighter in others — and wraps a little along the bottom. The rocks cast shade on the water, and on a hot day (from the live temperature) the fish drift over to loiter in the cool. Rocks are permanent — they poke up through the winter ice.
...
**M7** — pond layout & flow: lily pads grouped in the right third; a left-side shore (soil bank + a half-embedded stone shoreline, uneven and wrapping a little along the bottom) that casts shade the fish loiter in on a hot day (live temperature); tall, varied wide-leaf water plants along the shore and a few in the open water; and a gentle top-left-waterfall → bottom-right-pump current that the caustics and drifting foliage ride. Adds real pond-edge character.
