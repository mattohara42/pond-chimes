...
- **Rocks** — big, smooth boulders with a scatter of pebbles form an uneven rocky bank down the left edge that wraps along the bottom (thicker in places, tighter in others, like a real shoreline). They cast shade on the water, and on a hot day (from the live temperature) the fish drift over to loiter in the cool. Rocks are permanent — they poke up through the winter ice.
